...
src/features/semantic-graph.slice/centralized-selectors/eligible-tags.selector.ts
...
## File: src/features/semantic-graph.slice/centralized-selectors/eligible-tags.selector.ts
```typescript
