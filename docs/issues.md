...
> **Last verified**: 2026-03-03 — ARCH-D3-003, ARCH-D3-004, TYPE-D19-001, ARCH-D6-003 fixed and archived  
...
> **Archive**: Resolved issues → [`docs/issues-archive.md`](./issues-archive.md) (12 entries)
...
| P8 | ARCH-D6-002 | Rename `_shell/` to `_components/shell/` or amend D6 | Low-risk rename |
