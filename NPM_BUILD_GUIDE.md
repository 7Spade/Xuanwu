...
**為什麼使用 `--legacy-peer-deps`？**
- Angular 21.1.3 與 @angular/fire@20.0.1 之間存在 peer dependency 衝突
- 使用此選項可以繞過 peer dependency 檢查
- 所有功能經過測試，運作正常
...
### Q1: 為什麼需要使用 `--legacy-peer-deps`？

**A**: Angular 21 與 @angular/fire@20 之間存在 peer dependency 版本衝突。使用此選項可以繞過檢查，所有功能已測試正常。
