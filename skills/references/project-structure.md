...
src/
  ...
  app-runtime/
    ...
    providers/
      ...
      app-provider.tsx (8 lines)
      auth-provider.tsx (12 lines)
      firebase-provider.tsx (5 lines)
  ...
  features/
    account.slice/
      ...
      acc-outbox.ts (31 lines)
      account-event-bus.ts (53 lines)
      index.ts (0 lines)
    global-search.slice/
      _components/
    ...
    identity.slice/
      ...
      _token-refresh-listener.ts (7 lines)
      index.ts (0 lines)
    ...
    workforce-scheduling.slice/
      ...
      _timeline.queries.ts (18 lines)
      _timeline.types.ts (4 lines)
      _write-op.ts (3 lines)
      index.ts (0 lines)
      sched-outbox.ts (21 lines)
    workspace.slice/
      application/
  ...
  shadcn-ui/
    ...
    card.tsx (1 lines)
    carousel.tsx (29 lines)
    chart.tsx (22 lines)
    checkbox.tsx (3 lines)
    collapsible.tsx (0 lines)
    command.tsx (8 lines)
    context-menu.tsx (5 lines)
    dialog.tsx (5 lines)
    drawer.tsx (4 lines)
    dropdown-menu.tsx (5 lines)
    empty.tsx (11 lines)
    field.tsx (7 lines)
    form.tsx (32 lines)
    ...
    label.tsx (3 lines)
    menubar.tsx (5 lines)
    navigation-menu.tsx (8 lines)
    pagination.tsx (15 lines)
    popover.tsx (1 lines)
  ...
  shared-infra/
    ...
    frontend-firebase/
      ...
      firestore/
        repositories/
          ...
          workspace-business.finance.repository.ts (54 lines)
    ...
    gateway-command/
      ...
      index.ts (0 lines)
      workspace-schedule-command.ts (21 lines)
    gateway-query/
      _registry.ts (20 lines)
      index.ts (0 lines)
    observability/
      _error-logger.ts (2 lines)
      _metrics-recorder.ts (5 lines)
      _trace-provider.ts (3 lines)
      index.ts (0 lines)
    outbox-relay/
      _relay.ts (53 lines)
      index.ts (0 lines)
  ...
  shared-kernel/
    ...
    infra-contracts/
      ...
      version-guard/
        index.ts (10 lines)
    observability/
      _error-log.ts (12 lines)
      _metrics.ts (10 lines)
      _trace.ts (12 lines)
      index.ts (0 lines)
    ports/
