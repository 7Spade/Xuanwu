...
- Only files matching these patterns are included: src/features/workspace.slice/**/*.ts, src/features/workspace.slice/**/*.tsx, src/features/semantic-graph.slice/**/*.ts, src/features/semantic-graph.slice/**/*.tsx, src/features/workforce-scheduling.slice/**/*.ts, src/features/workforce-scheduling.slice/**/*.tsx, src/shared-kernel/**/*.ts, src/shared-kernel/**/*.tsx, src/shared-infra/**/*.ts, src/shared-infra/**/*.tsx
...
424 files | 8,433 lines

| Language | Files | Lines |
|----------|------:|------:|
| TypeScript | 343 | 6,269 |
...
- `src/features/workspace.slice/business.tasks/_components/tasks-view.tsx` (72 lines)