...
import type { ParsingIntentContract } from '@/features/workspace.slice/domain.parsing-intent/_contract';
import { createParsingIntentContract } from '@/features/workspace.slice/domain.parsing-intent/_contract';
import type {
