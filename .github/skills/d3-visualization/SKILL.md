...
description: D3 ecosystem guidance for designing and implementing interactive charts and diagrams in Angular with signals-first architecture, accessibility support, and performance optimization. Use when creating data visualizations, interactive charts, diagrams, or custom SVG-based graphics.
---
