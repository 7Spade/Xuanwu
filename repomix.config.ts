...
export default defineConfig({
  ...
  include: ["src/features/semantic-graph.slice/**/*.ts", "src/features/semantic-graph.slice/**/*.tsx", "src/features/workforce-scheduling.slice/**/*.ts", "src/features/workforce-scheduling.slice/**/*.tsx", "src/shared-kernel/**/*.ts", "src/shared-kernel/**/*.tsx", "src/shared-infra/**/*.ts", "src/shared-infra/**/*.tsx"
  ],
  ignore: {
    // 排除不必要的路徑
    customPatterns: [
