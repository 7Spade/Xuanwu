 ...
 *
 * Per 00-LogicOverview.md [R5] DLQ 三級策略:
 *
 ...
 *            [00-LogicOverview.md VS2 ACC_OUTBOX, VS4 ORG_OUTBOX, GEMINI.md §4]
 * Invariant: SkillRecognitionGranted/Revoked MUST route to REVIEW_REQUIRED.
 *            [00-LogicOverview.md VS4 ORG_OUTBOX: SkillRecog → REVIEW_REQUIRED]
...
const EVENT_TYPE_DLQ_LEVEL: Readonly<Record<string, DlqLevel>> = {
  ...
  // [00-LogicOverview.md VS2 ACC_OUTBOX] [GEMINI.md §4: auto-replay FORBIDDEN]
  'identity:claims:refreshFailed': 'SECURITY_BLOCK',
  'account:role:changed': 'SECURITY_BLOCK',
  'account:policy:changed': 'SECURITY_BLOCK',
  // [00-LogicOverview.md VS4 ORG_OUTBOX: "RoleChanged・PolicyChanged → SECURITY_BLOCK"]
  ...
  // [00-LogicOverview.md VS4 ORG_OUTBOX: PolicyChanged → SECURITY_BLOCK]
  ...
  // standing — require human review before replay. [00-LogicOverview.md VS4 ORG_OUTBOX]
  'organization:skill:recognitionGranted': 'REVIEW_REQUIRED',
  'organization:skill:recognitionRevoked': 'REVIEW_REQUIRED',
  // Per 00-LogicOverview.md VS6 SCHED_OUTBOX: "Compensating Events → SAFE_AUTO".
