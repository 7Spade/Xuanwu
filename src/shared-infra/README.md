...
**Design principle:** Security rules enforce data ownership and membership invariants that mirror the domain rules defined in `docs/architecture/README.md` — they are not the source of truth, but they must stay in sync with it.
