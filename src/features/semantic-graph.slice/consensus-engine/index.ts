 ...
 *
 * semantic-graph.slice/consensus-engine — 全域共識校驗 [D21-I D21-K]
 *
 ...
 *
 * Design contract:
 *   [D21-I] 全域共識律 — all tag governance proposals must pass consensus
 *           logic-consistency validation before reaching the BBB layer.
 *   [D21-K] 語義衝突裁決 — proposals that would create governance-level
 ...
 *
 * 此實作已交叉參考 docs/architecture/logic-overview.md [D21-I D21-K]
 */
