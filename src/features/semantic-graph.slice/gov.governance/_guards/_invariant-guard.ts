 ...
 *   [D21-K] 隤儔銵?鋆捱 ??proposals violating semantic / physical logic are
 ...
 *
 * 甇文祕雿歇鈭文???INDEX.md 銝衣泵??logic-overview.md 銋?[D21-H D21-K D21-9 D21-3] 閬?
 */

import { getAllEdges } from '../../domain.graph/_edges/_semantic-edge-store';
