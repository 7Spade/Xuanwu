...
// =================================================================
export { buildTagEntity } from './core/_nodes/_tag-entity.factory';
export type { TagEntityFactoryInput } from './core/_nodes/_tag-entity.factory';
...
// =================================================================
export type { IEmbeddingPort } from './core/_embeddings/_embedding-port';
export {
  injectEmbeddingPort,
  NOOP_EMBEDDING_PORT,
  buildTagEmbedding,
  buildTagEmbeddingsBatch,
} from './core/_embeddings/_embedding-port';
...
} from './domain.output/_projections/_tag-snapshot.slice';
export type {
...
// =================================================================
export { validateEdgeProposal } from './gov.governance/_guards/_invariant-guard';
export type {
  EdgeProposal,
  SemanticGuardDecision,
  SemanticGuardRejectionCode,
  SemanticGuardResult,
} from './gov.governance/_guards/_invariant-guard';
...
// =================================================================
export { validateConsensus } from './gov.governance/_semantic-governance-portal/consensus-engine';
export type {
  ConsensusDecision,
  ConsensusRejectionCode,
  ConsensusResult,
} from './gov.governance/_semantic-governance-portal/consensus-engine';
