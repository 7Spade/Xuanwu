...
import { useAccountTimeline, useTimelineCommands } from "../../_hooks/runtime";
    ...
    return (
      <div className="flex flex-col items-center gap-4 p-8 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Organization timeline is only available in the organization scope.
        </p>
      </div>
    );
  }
    ...
    <div className="mx-auto flex h-full max-w-full flex-col gap-6 duration-700 animate-in fade-in">
      <div className="space-y-1">
        ...
        <p className="flex items-center gap-2 text-muted-foreground">
          ...
          Use the timeline view to review and adjust organization plans.
        </p>
      </div>
