 ...
 *   WORKSPACE_OUTBOX -> ScheduleProposed (cross-layer handoff) -> ORGANIZATION_SCHEDULE
...
import {
  ...
  type WriteOp,
} from '../_types/_aggregate.types';
import { enqueueSchedulingOutboxEvent } from '../../domain.application/_commands/_sched-outbox';

export { ORG_SCHEDULE_STATUSES, orgScheduleProposalSchema } from '../_types/_aggregate.types';
export type {
  OrgScheduleProposal,
  OrgScheduleStatus,
