 ...
 *
 * Per docs/architecture/README.md invariants #4a / #4b:
 ...
 *
 * Flow: WORKSPACE_TRANSACTION_RUNNER -> WORKSPACE_OUTBOX -> WORKSPACE_EVENT_BUS
 *
 ...
 *
 * Per docs/architecture/README.md WS_OB [SK_OUTBOX: SAFE_AUTO][E5]:
 ...
 *
 * Per docs/architecture/README.md WS_OB [E5]: ws-outbox is the sole IER delivery path.
 ...
 * [docs/architecture/README.md: WS_OB["ws-outbox [SK_OUTBOX: SAFE_AUTO]"]]
 */
const WS_OUTBOX_PERSISTED_EVENTS = new Set<WorkspaceEventName>([
  'workspace:parsing-intent:deltaProposed',
]);

/** DLQ tier for all ws-outbox entries per docs/architecture/README.md WS_OB annotation. */
const WS_OUTBOX_DLQ_TIER: DlqTier = 'SAFE_AUTO';

/** IER lane for ws-outbox delivery per docs/architecture/README.md WS_OB [E5]. */
