 ...
 *
 * Per docs/architecture/README.md (VS7 enhanced):
 ...
 *   4. Return dispatch result (actual delivery delegated to domain.notification)
 */
 ...
 *
 * Per docs/architecture/README.md (VS7):
